...
(function() {
    ...
    var Inspector = {};
    (function() {
        var _key, _isWebkit = "WebkitAppearance" in document.documentElement.style,
            $body;
        ...
        var _deleteSelectedObjects = function(inspector) {
            var objects = [],
                object, worldTree = inspector.controls.worldTree.data("jstree"),
                i;
    ...
    if (!e.jstree) {
        ...
        l.setAttribute("role", "treeitem"), c = d.createElement("I"), c.className = "jstree-icon jstree-ocl", l.appendChild(c), c = d.createElement("A"), c.className = "jstree-anchor", c.setAttribute("href", "#"), h = d.createElement("I"), h.className = "jstree-icon jstree-themeicon", c.appendChild(h), l.appendChild(c), c = h = null, e.jstree = {
            ...
            get_node: function(t, i) {
                ...
                try {
                    ...
                    else if (((n = e(t, this.element)).length || (n = e("#" + t.replace(e.jstree.idregex, "\\$&"), this.element)).length) && this._model.data[n.closest("li").attr("id")]) t = this._model.data[n.closest("li").attr("id")];
                    else {
            ...
            _parse_model_from_html: function(i, n, r) {
                ...
                })), c = i.children("a:eq(0)").length ? i.children("a:eq(0)").clone() : i.clone(), c.children("ins, i, ul").remove(), c = c.html(), c = e("<div />").html(c), d.text = c.html(), c = i.data(), d.data = c ? e.extend(!0, {}, c) : null, d.state.opened = i.hasClass("jstree-open"), d.state.selected = i.children("a").hasClass("jstree-clicked"), d.state.disabled = i.children("a").hasClass("jstree-disabled"), d.data && d.data.jstree)
                    for (l in d.data.jstree) d.data.jstree.hasOwnProperty(l) && (d.state[l] = d.data.jstree[l]);
            ...
            _parse_model_from_flat_json: function(e, i, n) {
                ...
                if (e && e.data && e.data.jstree && e.data.jstree.icon && (h.icon = e.data.jstree.icon), e && e.data && (h.data = e.data, e.data.jstree))
                    for (o in e.data.jstree) e.data.jstree.hasOwnProperty(o) && (h.state[o] = e.data.jstree[o]);
                if (e && "object" == typeof e.state)
                    for (o in e.state) e.state.hasOwnProperty(o) && (h.state[o] = e.state[o]);
                if (e && "object" == typeof e.li_attr)
                    for (o in e.li_attr) e.li_attr.hasOwnProperty(o) && (h.li_attr[o] = e.li_attr[o]);
                if (h.li_attr.id || (h.li_attr.id = r), e && "object" == typeof e.a_attr)
                    for (o in e.a_attr) e.a_attr.hasOwnProperty(o) && (h.a_attr[o] = e.a_attr[o]);
            ...
            open_all: function(e, t, i) {
                ...
                var n = "#" === e.id ? this.get_container_ul() : this.get_node(e, !0),
                    r, s, a;
                if (!n.length) {
            ...
            close_all: function(t, i) {
                ...
                var n = "#" === t.id ? this.get_container_ul() : this.get_node(t, !0),
                    r = this,
                    s, a;
                if (!n.length) {
            ...
            activate_node: function(e, i) {
                ...
                if (this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent))
                    ...
                    } else this.is_selected(e) ? this.deselect_node(e, !1, !1, i) : this.select_node(e, !1, !1, i);
                    else !this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && this.is_selected(e) ? this.deselect_node(e, !1, !1, i) : (this.deselect_all(!0), this.select_node(e, !1, !1, i), this._data.core.last_clicked = this.get_node(e));
            ...
            get_top_selected: function(t) {
                ...
                for (r = 0, s = i.length; s > r; r++)
                    for (a = 0, o = i[r].children_d.length; o > a; a++) n[i[r].children_d[a]] && delete n[i[r].children_d[a]];
                i = [];
            ...
            refresh_node: function(t) {
                if (t = this.get_node(t), !t || "#" === t.id) return !1;
                var i = [],
                    n = this._data.core.selected.concat([]);
            ...
            get_json: function(e, t, i) {
                ...
                if (t && t.flat ? n.parent = e.parent : n.children = [], !t || !t.no_state)
                    for (r in e.state) e.state.hasOwnProperty(r) && (n.state[r] = e.state[r]);
                if (t && t.no_id && (delete n.id, n.li_attr && n.li_attr.id && delete n.li_attr.id), t && t.flat && "#" !== e.id && i.push(n), !t || !t.no_children)
                    for (r = 0, s = e.children.length; s > r; r++) t && t.flat ? this.get_json(e.children[r], t, i) : n.children.push(this.get_json(e.children[r], t));
            ...
            check: function(t, i, n, r, s) {
                ...
                var a = t.match(/^move_node|copy_node|create_node$/i) ? n : i,
            ...
            edit: function(i, n) {
                ...
                var r = this._data.core.rtl,
                    ...
                    o = e("<span>"),
                    d = "string" == typeof n ? n : this.get_text(i),
                    l = e("<div />", {
                        css: {
                            position: "absolute",
                            top: "-200px",
                    ...
                    c = e("<input />", {
                        ...
                        blur: e.proxy(function() {
                            var e = o.children(".jstree-rename-input"),
                                t = e.val();
            ...
            this.bind = function() {
                i.bind.call(this), this._data.checkbox.uto = !1, this.element.on("init.jstree", e.proxy(function() {
                    ...
                    if (r.state.selected) {
                        ...
                        for (d = 0, l = s.length; l > d; d++)
                            if (n[s[d]].state.selected) {
                    ...
                    while (o && "#" !== o.id) {
                        for (d = 0, l = 0, c = o.children.length; c > l; l++) d += a[o.children[l]].state.selected;
                        if (d === c) o.state.selected || (o.state.selected = !0, this._data.core.selected.push(o.id), h = this.get_node(o, !0), h && h.length && h.children(".jstree-anchor").addClass("jstree-clicked"));
                        else {
                ...
                for (this.element.find(".jstree-closed").not(":has(ul)").each(function() {
                    var e = a.get_node(this),
                        r;
                    if (e.state.loaded)
                        for (t = 0, i = e.children_d.length; i > t; t++) r = n[e.children_d[t]], !r.state.loaded && r.original && r.original.state && r.original.state.undetermined && r.original.state.undetermined === !0 && (s.push(r.id), s = s.concat(r.parents));
                    else e.original && e.original.state && e.original.state.undetermined && e.original.state.undetermined === !0 && (s.push(e.id), s = s.concat(e.parents));
        ...
        function(e) {
                ...
                _show_submenu: function(t) {
                    if (t = e(t), t.length && t.children("ul").length) {
                        var n = t.children("ul"),
                            ...
                            a = n.width(),
                            o = n.height(),
                            d = e(window).width() + e(window).scrollLeft(),
            ...
            this.bind = function() {
                n.bind.call(this), this.element.on("mousedown.jstree touchstart.jstree", ".jstree-anchor", e.proxy(function(i) {
                    var n = this.get_node(i.target),
                        r = this.is_selected(n) ? this.get_selected().length : 1;
            ...
            var i = !1,
                n = !1,
                r = !1,
                s = e('<div id="jstree-marker">&#160;</div>').hide().appendTo("body");
            e(document).bind("dnd_start.vakata", function(e, t) {
                ...
                if (r && clearTimeout(r), o.data.jstree && (!o.event.target.id || "jstree-marker" !== o.event.target.id)) {
                    var d = e.jstree.reference(o.event.target),
                        l = !1,
                        c = !1,
                        h = !1,
                        _, u, g, f, p, m, v, y, j, x, k, b;
                    if (d && d._data && d._data.dnd)
                        if (s.attr("class", "jstree-" + d.get_theme()), o.helper.children().attr("class", "jstree-" + d.get_theme()).find(".jstree-copy:eq(0)")[o.data.origin && (o.data.origin.settings.dnd.always_copy || o.data.origin.settings.dnd.copy && (o.event.metaKey || o.event.ctrlKey)) ? "show" : "hide"](), o.event.target !== d.element[0] && o.event.target !== d.get_container_ul()[0] || 0 !== d.get_container_ul().children().length) {
                            ...
                            for (v = !0, y = 0, j = o.data.nodes.length; j > y; y++)
                                if (v = v && d.check(o.data.origin && (o.data.origin.settings.dnd.always_copy || o.data.origin.settings.dnd.copy && (o.event.metaKey || o.event.ctrlKey)) ? "copy_node" : "move_node", o.data.origin && o.data.origin !== d ? o.data.origin.get_node(o.data.nodes[y]) : o.data.nodes[y], "#", "last", {
                                    dnd: !0,
                                    ref: d.get_node("#"),
                                    pos: "i",
                                    is_multi: o.data.origin && o.data.origin !== d,
        ...
        function(e) {
            ...
            this.bind = function() {
                i.bind.call(this), this._data.search.str = "", this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], this.element.on("before_open.jstree", e.proxy(function(t, i) {
                    var n, r, s, a = this._data.search.res,
                        o = [],
                        d = e();
                    if (a && a.length) {
        ...
        function(e) {
            e.vakata.search = function(e, t, i) {
                ...
                return a > 32 && (i.fuzzy = !1), i.fuzzy && (o = 1 << a - 1, d = function() {
                    ...
                    for (-1 !== u && (_ = Math.min(l(0, u), _), u = t.lastIndexOf(e, n + a), -1 !== u && (_ = Math.min(l(0, u), _))), u = -1, r = 0; a > r; r++) {
                        ...
                        for (p = f, v = Math.max(1, n - f + 1), y = Math.min(n + f, h) + a, j = Array(y + 2), j[y + 1] = (1 << r) - 1, c = y; c >= v; c--)
                            if (x = d[t.charAt(c - 1)], j[c] = 0 === r ? (1 | j[c + 1] << 1) & x : (1 | j[c + 1] << 1) & x | (1 | (m[c + 1] | m[c]) << 1) | m[c + 1], j[c] & o && (k = l(r, c - 1), _ >= k)) {
            ...
            this.bind = function() {
                ...
                if (t = this.get_node(t), t && t.children && t.children.length && (t.children.sort(e.proxy(this.settings.sort, this)), i))
                    for (n = 0, r = t.children_d.length; r > n; n++) this.sort(t.children_d[n], !1);
            };
        };
        var u = !1;
        ...
        function(e, t) {
            ...
            this.init = function(e, i) {
                ...
                if (i && i.types && i.types["default"])
                    for (r in i.types)
                        if ("default" !== r && "#" !== r && i.types.hasOwnProperty(r))
                            for (s in i.types["default"]) i.types["default"].hasOwnProperty(s) && i.types[r][s] === t && (i.types[r][s] = i.types["default"][s]);
                ...
                if (l === !1) return !1;
                if (e.isArray(l))
                    for (s = 0, a = l.length; a > s; s++) l[s].type = l[s].id && o[l[s].id] && o[l[s].id].type ? o[l[s].id].type : "default", i && i.no_id && (delete l[s].id, l[s].li_attr && l[s].li_attr.id && delete l[s].li_attr.id);
                else l.type = l.id && o[l.id] && o[l.id].type ? o[l.id].type : "default", i && i.no_id && (l = this._delete_ids(l));
                return l;
                ...
                var d = r && r.id ? e.jstree.reference(r.id) : null,
                    l, c, h, _;
        ...
        g.setAttribute("unselectable", "on"), g.className = "jstree-wholerow", g.innerHTML = "&#160;", e.jstree.plugins.wholerow = function(t, i) {
            this.bind = function() {
                ...
                if (t = i.redraw_node.call(this, t, n, r)) {
                    var s = g.cloneNode(!0); - 1 !== e.inArray(t.id, this._data.core.selected) && (s.className += " jstree-wholerow-clicked"), t.insertBefore(s, t.childNodes[0]);
                }
                return t;
            };
        };

...
function agentPointSpriteUpdaterSys(state) {
  if (!state.pointSpriteMeshEntity) {
    ...
    var pointSpriteMaterial = new AgentsMaterial({ pointSize: 30 * state.DPI, texture: Texture2D.load(image), texSize: new Vec2(1/10, 1/15), texOffset: new Vec2(1/10, 1/15) });

...
var SocietyBlobs = [
  { center: { x: 1.20, y:-0.80, z: 0 }, radius: 0.40, numCells: 25, energy: 'knowledge', roomType: 'knowledgeBlob' },
  { center: { x: 0.80, y: 0.60, z: 0 }, radius: 0.24, numCells:  5, energy: 'knowledge', roomType: 'knowledgeBlob' },
  { center: { x: 1.20, y: 0.17, z: 0 }, radius: 0.30, numCells:  9, energy: 'knowledge', roomType: 'knowledgeBlob' },
  { center: { x:-1.20, y: 0.25, z: 0 }, radius: 0.30, numCells: 16, energy: 'power',     roomType: 'powerBlob'     },
  { center: { x:-1.30, y:-0.60, z: 0 }, radius: 0.23, numCells: 10, energy: 'power',     roomType: 'powerBlob'     },
